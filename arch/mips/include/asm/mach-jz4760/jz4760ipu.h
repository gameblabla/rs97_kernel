...
#define REG_IN_GS		0x18 /* Input Geometric Size Register */
...
/* for rs97 */
#define REG_IPU_CTRL 		          REG32(IPU_BASE + REG_CTRL)
#define REG_IPU_STATUS 	          REG32(IPU_BASE + REG_STATUS)
#define REG_IPU_Y_ADDR 	          REG32(IPU_BASE + REG_Y_ADDR)
#define REG_IPU_D_FMT 	          REG32(IPU_BASE + REG_D_FMT)
#define REG_IPU_IN_GS 	          REG32(IPU_BASE + REG_IN_GS)
#define REG_IPU_Y_STRIDE          REG32(IPU_BASE + REG_Y_STRIDE)
#define REG_IPU_UV_STRIDE         REG32(IPU_BASE + REG_UV_STRIDE)
#define REG_IPU_OUT_ADDR          REG32(IPU_BASE + REG_OUT_ADDR)
#define REG_IPU_OUT_GS            REG32(IPU_BASE + REG_OUT_GS)
#define REG_IPU_OUT_STRIDE        REG32(IPU_BASE + REG_OUT_STRIDE)
#define REG_IPU_RSZ_COEF_INDEX    REG32(IPU_BASE + REG_RSZ_COEF_INDEX)
#define REG_IPU_CSC_C0_COEF       REG32(IPU_BASE + REG_CSC_CO_COEF)
#define REG_IPU_CSC_C1_COEF       REG32(IPU_BASE + REG_CSC_C1_COEF)
#define REG_IPU_CSC_C2_COEF       REG32(IPU_BASE + REG_CSC_C2_COEF)
#define REG_IPU_CSC_C3_COEF       REG32(IPU_BASE + REG_CSC_C3_COEF)
#define REG_IPU_CSC_C4_COEF       REG32(IPU_BASE + REG_CSC_C4_COEF)
#define REG_IPU_IPU_HRSZ_COEF_LUT REG32(IPU_BASE + HRSZ_LUT_BASE)
#define REG_IPU_IPU_VRSZ_COEF_LUT REG32(IPU_BASE + VRSZ_LUT_BASE)
#define REG_IPU_CSC_OFSET_PARA    REG32(IPU_BASE + REG_CSC_OFSET_PARA)
#define REG_IPU_Y_PHY_T_ADDR      REG32(IPU_BASE + REG_Y_PHY_T_ADDR)
#define REG_IPU_U_PHY_T_ADDR      REG32(IPU_BASE + REG_U_PHY_T_ADDR)
#define REG_IPU_V_PHY_T_ADDR      REG32(IPU_BASE + REG_V_PHY_T_ADDR)
#define REG_IPU_OUT_PHY_T_ADDR    REG32(IPU_BASE + REG_OUT_PHY_T_ADDR)
